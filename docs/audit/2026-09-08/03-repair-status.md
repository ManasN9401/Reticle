...
| F45 | Partial | Lazy, serialized, cancellation-aware provisioning; exact direct skill/base pins; Python/platform-aware caches; host interpreter PATH consistency. Full transitive locks, immutable image builds and clean-machine install acceptance remain. |
